module CornellAssembliesRails
  module Rails
    ...
    autoload :DatetimePickerHelpers, 'cornell_assemblies_rails/rails/datetime_picker_helpers'
    autoload :DatetimePickerBuilderMethods, 'cornell_assemblies_rails/rails/datetime_picker_builder_methods'
    require 'squeel'
